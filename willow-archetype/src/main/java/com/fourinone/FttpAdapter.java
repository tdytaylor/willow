...
public final class FttpAdapter {
  ...
  public ByteFttpReadAdapter getByteFttpReader(long beginIndex, long bytesNum)
  ...
  public ByteFttpWriteAdapter getByteFttpWriter(long beginIndex, long bytesNum)
      throws FttpException {
  ...
  public interface ByteFttpReadAdapter extends TryByteReadAdapter {
    ...
    byte[] readAll() throws FttpException;//lockflag?setLock(true)

    byte[] readAllSafety() throws FttpException;
  }

  public interface IntFttpReadAdapter extends TryIntReadAdapter {

    int[] readIntAll() throws FttpException;

    int[] readIntAllSafety() throws FttpException;
  }
  ...
  public interface IntFttpWriteAdapter extends TryIntWriteAdapter {
    ...
    int writeInt(int[] its) throws FttpException;

    int writeIntSafety(int[] its) throws FttpException;
  ...
  public interface ByteFttpWriteAdapter extends TryByteWriteAdapter {
    ...
    int write(byte[] bytes) throws FttpException;

    int writeSafety(byte[] bytes) throws FttpException;
  }
