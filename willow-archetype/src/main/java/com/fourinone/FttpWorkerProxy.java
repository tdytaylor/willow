...
public class FttpWorkerProxy extends WorkerServiceProxy {
  ...
  public FileResult<byte[]> readAsyn(final String f, final long b, final long t,
  ...
  public FileResult<int[]> readIntAsyn(final String f, final long b, final long t,
      final boolean locked) {
  ...
  public FileResult<Integer> writeAsyn(final String f, final long b, final long t, final byte[] bs,
      final boolean locked) {
  ...
  public FileResult<Integer> writeIntAsyn(final String f, final long b, final long t,
      final int[] its, final boolean locked) {
    final FileResult<Integer> fr = new FileResult<Integer>(false);
    tpe().execute(new Runnable() {
      public void run() {
        try {
