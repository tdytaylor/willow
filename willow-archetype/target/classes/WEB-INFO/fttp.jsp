...
<form name=MyForm method="post">
        ...
        <tr>
            ...
            <td align=right>
                <select style='width:120' name="actionName" class="select" disabled>
                    <option value="editWithSelect('update_comFile.jsp?actionType=0');">VIEW PATH
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=1');">CREATE DIR
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=2');">CREATE FILE
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=3');">RENAME
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=4');">MOVETO
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=5');">DELETE
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=6');">DOWNLOAD
                        FILE
                    </option>
                    <option value="popWindowWithSelect('upload_comFile.jsp?actionType=7');">UPLOAD
                        FILE
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=8');">DOWNLOAD
                        JZIP
                    </option>
                    <option value="editWithSelect('update_comFile.jsp?actionType=9');">UNJZIP FILE
                    </option>
                    <option value="popWindowWithSelect('ejp.jsp?actionType=6&desFlag=true');">EDIT
                    </option>
    ...
    <div nowrap>
        ...
        <a id=proot href="javascript:menuClick(proot)" tid="root" tn="0"><b>Fttp
            NameNode</b></a><input type=radio name="treeId" value="isRoot=true&tid=root">
